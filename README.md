...
[![版本](https://img.shields.io/badge/版本-v0.88.06-blue.svg)](https://github.com/supkai0218/subtitle_AI_translator)
...
- ✅ **AI 自動翻譯**：整合多種 AI API（OpenRouter、OpenAI、Anthropic 等）
...
字幕AI翻譯系統
│
├── 主程式層 (ai-translator-main-v0.88.py)
│   ├── GUI 介面 (PyQt6)
...
### 3.2 主程式 (ai-translator-main-v0.88.py)
...
**功能**：根據規則移除不需要的文字內容，同步處理時間軸

**處理模組**：`text_filter_v01.py`
